              ...
              <div class="remarks-container">
                ...
                <div class="remarks-analyse-box">
                  ...
                  <div class="remarks-analyse-tags">
                    <Tag  v-for="(item,index) in goodsInfo.remarks.remarksTags" :key="index">{{item}}</Tag>
                  </div>
                </div>
                <div class="remarks-bar">
                  <span>全部评价({{goodsInfo.remarks.remarksNumDetail[0]}})</span>
                  <span>晒图({{goodsInfo.remarks.remarksNumDetail[1]}})</span>
                  <span>追评({{goodsInfo.remarks.remarksNumDetail[2]}})</span>
                  <span>好评({{goodsInfo.remarks.remarksNumDetail[3]}})</span>
                  <span>中评({{goodsInfo.remarks.remarksNumDetail[4]}})</span>
                  <span>差评({{goodsInfo.remarks.remarksNumDetail[5]}})</span>
                </div>
