    ...
    <div class="item-detail-show">
      ...
      <div class="item-detail-right">
        <div class="item-detail-title">
          <p>
            <span class="item-detail-express">京东到家</span> {{goodsInfo.title}}</p>
        </div>
          ...
          <div class="item-price-left">
            <div class="item-price-row">
              <p>
                ...
                <span class="item-price-jj">降价通知</span>
              </p>
            </div>
            <div class="item-price-row">
              <p>
            ...
            <div class="item-price-row">
              <p>
                <span class="item-price-title">服务支持</span>
                <span class="item-price-fwzc">放心购&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <span class="item-price-yxp">优鲜赔</span>
              </p>
            </div>
          </div>
